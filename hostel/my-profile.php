...
$query="update  userRegistration set regNo='$regno',firstName='$fname',lastName='$lname',gender='$gender',contactNo='$contactno',updationDate='$udate' where id='$aid'";
$run=$con->query($query);
	if($run == TRUE)
	{
		echo "<script>alert('Student Succssfully updated');</script>";	
	}
...
<div class="col-sm-8">
<input type="text" name="regno" id="regno"  class="form-control" required="required" value="<?php echo $row->id;?>" readonly>
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="contact" id="contact"  class="form-control" maxlength="10" value="<?php echo $row->contactNo;?>" >
</div>
</div>
