...
$stmt=$con->prepare("SELECT email,contactNo,password FROM userregistration WHERE (email=? && contactNo=?) ");
				...
				{
					echo "<script>alert('Invalid Email/Contact_no or password');</script>";
				}
			}
				?>
				...
				<div class="row">
						<?php if(isset($_POST['login']))
								{ 
									...
									echo "<script>
											window.alert('Your Password is:  $pwd  You can Change password After Log_In ');
					...
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="text-center text-light">
							<a href="index.php" class="">Sign in?</a>
						</div>
					</div>
				</div>
					<?PHP	
