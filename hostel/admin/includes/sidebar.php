<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="userlog.php"><i class="fa fa-list"></i>User Access Log</a></li>
				<li><a href="leave.php"><i class="fa fa-desktop"></i>Leave Requests</a></li>
				<li><a href="checkinout.php"><i class="fa fa-desktop"></i>Check-In/Out Lsists</a></li>
		</nav>