...
$qry1="insert into  userregistration(`regNo`,`firstName`,`lastName`,`gender`,`contactNo`,`email`,`password`) VALUES ('$regno','$fname','$lname','$gender','$contactno','$emailid','$contactno')";

	$run=$con->query($qry);
	$ren=$con->query($qry1);
	if($run == TRUE && $ren == TRUE)
	{
